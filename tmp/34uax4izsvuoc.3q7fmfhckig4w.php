            ...
            <div style="background-color:#49a6e8;">
                <div class="block-grid"
                    ...
                    <div style="border-collapse: collapse;display: table;width: 100%;background-color:transparent;">
                        ...
                        <![endif]-->
                        <div class="col num12"
                             style="min-width: 320px; max-width: 605px; display: table-cell; vertical-align: top;;">
                            <div style="width:100% !important;">
                                ...
                                <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:0px; padding-bottom:0px; padding-right: 0px; padding-left: 0px;">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="divider"
                                        ...
                                        <tr style="vertical-align: top;" valign="top">
                                            <td class="divider_inner"
                                                style="word-break: break-word; vertical-align: top; min-width: 100%; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; padding-top: 20px; padding-right: 20px; padding-bottom: 20px; padding-left: 20px; border-collapse: collapse;"
                                                valign="top">
                                    ...
                                    <div align="center" class="img-container center autowidth"
                                        ...
                                        <![endif]--><a href="http://example.com" target="_blank"> </a>
                                    ...
                                    <![endif]-->
                                    <div style="color:#FFFFFF;font-family:'Bitter', Georgia, Times, 'Times New Roman', serif;line-height:120%;padding-right:10px;padding-bottom:30px;padding-left:10px;">
                                        <div style="font-size: 12px; line-height: 14px; font-family: 'Bitter', Georgia, Times, 'Times New Roman', serif; color: #FFFFFF;">
                                            <p style="font-size: 14px; line-height: 33px; text-align: center; margin: 0;">
                                                <span style="font-size: 28px;">Calendar app</span></p>
                                        </div>
                                    </div>
                                    ...
                                    <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:0px; padding-bottom:0px; padding-right: 0px; padding-left: 0px;">
                                        ...
                                        <div style="color:#134C75;font-family:'Bitter', Georgia, Times, 'Times New Roman', serif;line-height:120%;padding-top:30px;padding-right:30px;padding-bottom:5px;padding-left:30px;">
                                            <div style="font-size: 12px; line-height: 14px; font-family: 'Bitter', Georgia, Times, 'Times New Roman', serif; color: #134C75;">
                                                <p style="font-size: 14px; line-height: 28px; text-align: center; margin: 0;">
                                                    <span style="font-size: 24px;"><strong> meeting</strong></span></p>
                                            </div>
                                        </div>
                                        <!--[if mso]></td></tr></table><![endif]-->
                                        <!--[if mso]>
                                        ...
                                        <div style="color:#7E7E7E;font-family:'Open Sans', Helvetica, Arial, sans-serif;line-height:150%;padding-top:5px;padding-right:30px;padding-bottom:20px;padding-left:30px;">
                                            <div style="font-size: 12px; line-height: 18px; color: #7E7E7E; font-family: 'Open Sans', Helvetica, Arial, sans-serif;">
                                                <p style="font-size: 14px; line-height: 21px; text-align: center; margin: 0 20px;">
                                                    <b>Bonjour,</b>
                                                ...
                                                <?php foreach (($event?:[]) as $item): ?>
                                                    <a href="#"
                                                            ...
                                                            target="_blank">
                                                        <span
                                                            style="font-size: 12px; line-height: 20px;"><?= ($item['START_DATE']) ?> - <?= ($item['END_DATE'])."
" ?>
                                                        </span>
                                                    </a>
                                                <?php endforeach; ?>
                                                <p>Event details: <?= ($item['DETAILS']) ?></p>
                                                <!--<p>Event date : '.$event_start.'</p></p>-->
                                            </div>
                                        </div>
                                        <!--[if mso]></td></tr></table><![endif]-->
                                                ...
                                                <tr>
                                                    <td style="padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px"
                                                        ...
                                                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                                     ...
                                                                     style="height:31.5pt; width:121.5pt; v-text-anchor:middle;"
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" class="divider"
                                            ...
                                            <tr style="vertical-align: top;" valign="top">
                                                <td class="divider_inner"
                                                    style="word-break: break-word; vertical-align: top; min-width: 100%; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; padding-top: 20px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px; border-collapse: collapse;"
                                                    valign="top">
                                                    <div align="center" class="button-container"
                                                         style="padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                                        <a href="#"
                                                           style="-webkit-text-size-adjust: none; text-decoration: none; display: inline-block; color: #ffffff; background-color: #aeb4b8; border: none; width: auto; width: auto;  padding-top: 5px; padding-bottom: 5px; font-family: 'Open Sans', Helvetica, Arial, sans-serif; text-align: center; mso-border-alt: none; word-break: keep-all;"
                                                           target="_blank"><span
                                                                style="padding-left:25px;padding-right:25px;font-size:14px;display:inline-block;"><span
                                                                style="font-size: 16px; line-height: 32px;"><span
                                                                data-mce-style="font-size: 14px;"
                                                                style="font-size: 14px; line-height: 28px;">Report AS A Spam</span></span></span></a>
                                                        <a href="#"
                                                           style="-webkit-text-size-adjust: none; text-decoration: none; display: inline-block; color: #ffffff; background-color: #aeb4b8; border: none;width: auto; width: auto; padding-top: 5px; padding-bottom: 5px; font-family: 'Open Sans', Helvetica, Arial, sans-serif; text-align: center; mso-border-alt: none; word-break: keep-all;"
                                                           target="_blank"><span
                                                                style="padding-left:25px;padding-right:25px;font-size:14px;display:inline-block;"><span
                                                                style="font-size: 16px; line-height: 32px;"><span
                                                                data-mce-style="font-size: 14px;"
                                                                style="font-size: 14px; line-height: 28px;">Unsubscribe</span></span></span></a>
                                                        <p style="font-size: 14px; line-height: 21px; text-align: center; margin: 0; color:grey; width: 100%;margin-top:20px">
                                                            Vous avez reçu cet email car vous êtes invité à chosir une
                                                            date pour la demande de service effectuée sur la plateforme
                                                            eCity</p>
                                                    </div>
                                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                                           class="divider_content" role="presentation"
                ...
                <div style="background-color:transparent;">
                    <div class="block-grid mixed-two-up"
                         style="Margin: 0 auto; min-width: 320px; max-width: 605px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; background-color: transparent;;">
                        <p style="font-size: 14px; line-height: 21px; text-align: center; margin: 0; color:#fff; width: 100%;padding:20px;">
                            eCity, 5 Place Léon Meyer - 76600 LE HAVRE</p>
                    </div>
                </div>
            </div>
                <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
